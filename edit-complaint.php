                ...
                <fieldset>
                    ...
                    <div>
                        ...
                        <select id="employee_taking" name="employee_taking" required>
                            ...
                            ?>
                                <option value="<?php echo $employee['id']; ?>" <?php if ($complaint[0]['taken_by_employee_id'] == $employee['entity_id']) {
                                                                                    print('selected');
                    ...
                    <div>
                        ...
                        <select id="employee_entered" name="employee_entered" required>
                            ...
                            ?>
                                <option value="<?php echo $employee['id']; ?>" <?php if ($complaint[0]['entered_by_employee_id'] == $employee['entity_id']) {
                                                                                    print('selected');
                                                                                } ?>><?php echo $employee['first_name'] . " " . $employee['last_name']; ?></option>

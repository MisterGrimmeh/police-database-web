...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $db_select_complaint_stmt = $db_conn->prepare('SELECT * FROM `open_complaint`');
}
...
<section>
    <header>
        ...
        ?>
            <h1><a href="show-open-complaint.php">Complaint Report #<?php print($request_id); ?></a></h1>
        <?php
        } else {
        ?>
            <h1>All Open Complaint Reports</h1>
        <?php
        }
